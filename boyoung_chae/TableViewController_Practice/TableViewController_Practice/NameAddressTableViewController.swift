...
class NameAddressTableViewController: UITableViewController {

    static var selected:[String:String]?
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.detailTextLabel?.text = self.values[indexPath.row]["address"]
    ...
    override func tableView(_ tableView: UITableView, willSelectRowAt indexPath: IndexPath) -> IndexPath? {
        NameAddressTableViewController.selected = self.values[indexPath.row]
        return indexPath
    }
